...
- [4. 常见问题](#4-常见问题)
    ...
    - [4.2. 设置8:30-12:00考勤，但运行结果是0:30签到，4:00签退？](#42-设置830-1200考勤但运行结果是030签到400签退)
    - [4.3. 使用这个程序会泄露我的个人账号/密码吗？](#43-使用这个程序会泄露我的个人账号密码吗)
- [5. 参考资料](#5-参考资料)
...
## 4.2. 设置8:30-12:00考勤，但运行结果是0:30签到，4:00签退？
>Github Actions的时间是UTC时间，比北京时间慢8小时。因此8:30-12:00转换后就是0:30-4:00

<br>

## 4.3. 使用这个程序会泄露我的个人账号/密码吗？
